$(document).ready(function () {
    ...
    window.abrirDetalleProducto = function (id) {
        ...
        if (producto.precioAnterior && producto.precioAnterior > producto.precio) {
            ...
            $('#detailProductDiscount').html(`Etiqueta️ ${descuento}%`).show();
        } else {
    ...
    const subcategoriaIcons = {
        'avenas_cereales': 'Café',
        'panaderia_untables': 'Pan',
        'carnes_aves': 'Carnes',
        'verduras_frescas': 'Verduras',
        'bebidas_almuerzo': 'Bebidas',
        'abarrotes_almuerzo': 'Carrito',
        'jugos_galletas': 'Bebidas',
        'infusiones_ligeros': 'Infusión'
    };
